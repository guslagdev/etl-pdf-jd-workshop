...
from etl_pdf_jd_workshop.configs.tools.postgre import RDSPostgreSQLManager
from etl_pdf_jd_workshop.configs.rules.regras import rules_dict
...
class PDFTableExtractor:
    def __init__(self, file_name, configs):
        self.path = os.path.abspath(f"src/etl_pdf_jd_workshop/files/pdf/{configs['name'].lower()}/{file_name}.pdf")
        self.csv_path = os.path.abspath("src/etl_pdf_jd_workshop/files/csv/")
...
if __name__ == "__main__":
    ...
    corretora = 'redrex'
    path = os.path.abspath(f"src/etl_pdf_jd_workshop/files/pdf/{corretora}/")
